...
(function() { this.JST || (this.JST = {}); this.JST["search/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div>\n  <form>\n    <input type="text"\n      name="query"\n      placeholder="Search...">\n    <input type="submit" value="Submit">\n  </form>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["tips/multiple"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h2 class="sub-header">Tip Feed</h2>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["tips/single"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="tip-wrapper">\n    <div class="col-xs-8">\n        <div class="tip">\n            <p class="tip-paragraph">\n                ',  tip.get('text') ,'\n            </p>\n        </div>\n\n        <p class="tip-footnote">Submitted March 12th, 2014 at 11:47PM</p>\n    </div>\n\n    <div class="col-xs-4">\n        <ul>\n            <li><strong>',  tip.get('name') ,'</strong></li>\n            <li><a href="mailto:',  tip.get('email') ,'">',  tip.get('email') ,'</a></li>\n            <li>',  tip.get('subject') ,'</li>\n            <li>',  tip.get('city') ,', ',  tip.get('state') ,'</li>\n            <li><em>Does not want name publicized</em></li>\n            ');  if (tip.get('story')) { ; __p.push('\n              <li><a href="#">',  tip.get('story') ,'</a></li>\n            ');  } ; __p.push('\n        </ul>\n    </div>\n\n    <div class="clearfix"></div>\n</div>\n\n');}return __p.join('');};
}).call(this);
